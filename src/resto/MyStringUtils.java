...
public class MyStringUtils {
	...
	public static boolean isReadable(String filename) {
		try {
			...
			return false; // filename invalid => file cannot exist , never mind
							// be readable
		}
	}
	...
	public static String[] loadLine(BufferedReader inStream, String prefix, boolean isList)
		...
		// cut the prefix and the following colon off the line then trim it to
		...
		if (!contentString.equals("")) {
			...
			// a list attribute with empty contents is valid; use a zero−length
			// array to store its words
			words = new String[0];
		}
		return words;
	}
